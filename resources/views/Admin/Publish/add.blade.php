...
@section('content')
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">添加新的出版物</h1>
            </div>
            <!-- /.col-lg-12 -->
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="col-xs-12 col-md-6">
                                ...
                                <hr>
                                <form id="two-form" action="{{ url('/Admin/publish/insert') }}" method="post">
                                    {{ csrf_field() }}
                                    <div class="form-group">
                                        <label for="content">出版物描述</label>
                                        <input type="hidden" name="pic" value="{{ session('data')?session('data')['fileName']:'' }}" style="display: none;" />
                                        <input name="content" type="text" class="form-control" id="content" value="{{ session('data')?session('data')['content']:'' }}" placeholder="请输入出版物描述">
                                    </div>
