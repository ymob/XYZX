                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="col-xs-12 col-md-6">
                                ...
                                <hr>
                                <form id="two-form" action="{{ url('/Admin/banner/update') }}" method="post">
                                    {{ csrf_field() }}
                                    <div class="form-group">
                                        ...
                                        <input name="content" type="text" class="form-control" id="content" value="{{ session('data')?session('data')['content']:$data->content }}" placeholder="请输入图片描述，可以为空">
                                    </div>
