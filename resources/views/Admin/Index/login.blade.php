                        ...
                        <form role="form" action="{{ url('/login') }}" method="post">
                            ...
                            <fieldset>
                                <div class="form-group">
                                    <input class="form-control" placeholder="账号" name="master" value="{{ old('master')?old('master'):($master?$master->master:'') }}" type="text" autofocus>
                                </div>
                                <div class="form-group">
                                    <input class="form-control" placeholder="密码" name="password" type="password" value="{{ $master?$master->password:'' }}">
                                </div>
                                <div class="checkbox">
                                    <label>
