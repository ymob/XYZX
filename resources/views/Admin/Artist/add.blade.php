                            ...
                            <div class="col-xs-12 col-md-6">
                                ...
                                <form id="two-form" action="{{ url('/Admin/artist/insert') }}" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" rows="5" name="introduce" id="introduce" placeholder="请输入个人简介">{{ old('introduce')?old('introduce'):(session('data')?session('data')['introduce']:'') }}</textarea>
                                    </div>
