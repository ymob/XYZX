                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <form id="img-form" action="{{ url('/Admin/artist/detail/add') }}" method="post" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                ...
                                @foreach($data as $val)
                                    <div class="img-list">
                                        ...
                                        <div>
                                            ...
                                            <a href="{{ url('/Admin/artist/detail/delete/'.$val->id) }}" onclick="if(!confirm('删除之后不可恢复，确实要删除吗?')) return false;">
