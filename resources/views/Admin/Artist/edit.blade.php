...
@section('content')
	...
	<div id="page-wrapper">
	    <div class="row">
	        <div class="col-lg-12">
	            <h1 class="page-header">修改艺术家资料</h1>
	        </div>
	        <!-- /.col-lg-12 -->
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="col-xs-12 col-md-6">
                                ...
                                <hr>
                                <form id="two-form" action="{{ url('/Admin/artist/update') }}" method="post">
                                    {{ csrf_field() }}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="name" type="text" class="form-control" id="name" value="{{ old('name')?old('name'):(session('data')['name']?session('data')['name']:$data->name) }}" placeholder="请输入艺术家姓名">
                                    </div>
                                    <div class="form-group">
                                        <label for="introduce">个人简介</label>
                                        <textarea class="form-control" rows="5" name="introduce" id="introduce" placeholder="请输入个人简介">{{ old('introduce')?old('introduce'):(session('data')?session('data')['introduce']:$data->introduce) }}</textarea>
                                    </div>
