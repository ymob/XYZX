                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="col-xs-12 col-md-6">
                                ...
                                <hr>
                                <form id="two-form" action="{{ url('/Admin/activity/update') }}" method="post">
                                    {{ csrf_field() }}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="title" type="text" class="form-control" id="title" value="{{ old('title')?old('title'):(session('data')['title']?session('data')['title']:$data->title) }}" placeholder="请输入活动标题">
                                    </div>
                                    <div class="form-group">
